...
class RoomList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder(
        valueListenable: floorsBloc.showingNotifications,
        builder: (BuildContext context, bool showingNotification, _) {
          return Scaffold(
              appBar: AppBar(
                ...
                actions: <Widget>[
                  ElevatedButton(
                    onPressed: () {
                      // floorsBloc.showingNotifications.value =
                      //     floorsBloc.showingNotifications.value ? false : true;
              ...
              body:  StreamBuilder<FloorsModel>(
                      ...
                      builder: (context, snapshot) {
                        final FloorsModel model = snapshot.data==null?floorsBloc.model:snapshot.data;
                        return Column(
                                    ...
                                    return Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          child: Text(model.floorList[index]
                                              .toString()),
                                          onPressed: () =>
                            ...
                            Container(
                              child: Expanded(
                                ...
                                child: Container(
                                  ...
                                  child: ListView.builder(
                                    itemCount:
                                        model.selectedFloor.roomList.length,
                                    itemBuilder: (context, index) {
                                      return RoomListTile(
                                        model: model,
                                        roomIndex: int.parse(model.selectedFloor
